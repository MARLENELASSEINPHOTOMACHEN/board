...
- [x] Modular export architecture (see Export System below)
- [x] Export diagram as JSON
- [ ] Export diagram as PNG
- [x] Import diagram from JSON
...
- [x] `services/export/json.ts` - JSON export serialization, import validation
...
type ImportResult = { success: true; diagram: Diagram } | { success: false; errors: string[] };
...
- `export/` - Modular export system (JSON export/import with validation)
...
- Modular export system with type-safe per-format options (`src/lib/services/export/`)
